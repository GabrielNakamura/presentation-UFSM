...
.center[
.pull-left[
```{r echo=FALSE, out.width="90%", fig.cap="Reconstrução de Burguess", fig.alt= "A a photo with a dog and white flour on the sofa. The dog is with his mouth full of flour"}
 knitr::include_graphics("images/burguess-shale.jpeg")
```
]
]
...
## Ecologia como uma ciência histórica - padrões macroecológicos
...
- A importância de  **eventos históricos em padrões macroecológicos**

- **História biogeográfica** de diferentes regiões
...
- modelos macroevolutivos para estimativa de **área ancestral**
